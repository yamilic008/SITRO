                                    ...
                                    <tbody>
                                        @foreach($roles as $dato)
                                           <tr>
                                              <td> {{ $dato->id }}</td>
                                           <td> {{ $dato->name }}</td>
                                           <td> {{ $dato->guard_name }}</td>
                                           <td> {{ $dato->getPermissionNames()->implode(', ')}}</td>
                                            
                                            <td>
                                               
                                                <a href="{{route ('roles.edit',$dato->id)}}" class="btn btn-xs btn-primary waves-effect">
                                                                         <i class="material-icons" style="font-size: 16px;">edit</i>
                                                </a>
                                                <form method='POST' 
                                                      action="{{route('roles.destroy',$dato['id'])}}"
