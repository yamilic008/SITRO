...
@section('content')
<form name="MyForm" class="form-horizontal" method="POST" action="{{ route('articulo.store') }}"  >
    {{ csrf_field() }}
                        ...
                        <div class="body">
                          ...
                          <div class="row clearfix">
                              ...
                              <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                  <div class="form-group">
                                      <div class="form-line">
                                          <input type="text" class="form-control" placeholder="Nombre del Articulo o Servicio" name="articulo" required autofocus>
                                      </div>
                                  </div>
                              </div>
                          </div>
                          <div class="row clearfix">
                              ...
                              <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                  <div class="form-group">
                                      <div class="form-line">
                                          <input type="number" class="form-control" placeholder="Numero de Articulos o Servicios" name="cantidad" required autofocus onChange="sumar()" min="0" step="any">
                                      </div>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="row clearfix">
                              ...
                              <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                  <div class="form-group">
                                      <div class="form-line">
                                          <textarea rows="4" class="form-control no-resize" name="observacion" placeholder="Agrega una observacion...." required autofocus></textarea>
                                      </div>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="row clearfix">
                              ...
                              <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                  <div class="input-group">
                                      ...
                                      <div class="form-line">
                                          <input  type="number" class="form-control" id="precio" name="precio" placeholder="" onChange="sumar()" value="0"  autofocus step="any" required autofocus>
                                          <input  type="hidden" class="form-control" id="temporal" name="temporal" placeholder="" onChange="sumar()">
                                      </div>
                                  </div>
                              </div>
                          </div>
...
function sumar() 
{
    ...
    if (c3==true)
    {
       /* var field = document.getElementById("precio");
        var field1 = document.getElementById("temporal");*/
...
/*        field.id = "temporal";                      // using element properties
        field1.id = "precio";   
        field.setAttribute("name", "temporal");     // using .setAttribute() method
        field1.setAttribute("name", "precio");     // using .setAttribute() method*/
        
    }
     if (c3==false)
     {
        /*field.id = "precio";                      // using element properties
        field1.id = "temporal";   
        field.setAttribute("name", "precio");     // using .setAttribute() method
        field1.setAttribute("name", "temporal");     // using .setAttribute() method*/
