                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                              @if(auth()->user()->hasRole('AdministradorA'))
                                @if($caducidad >0)
                                 <li class="dropdown">
                                   <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Nuevo">
                                           ...
                                           <tr>
                                              ...
                                              <td> 
                                                 ...
                                                 @if( $dat->estatus==='0%')
                                                  ...
                                                  @if($dat->estatus==='75%')
                                                     <div class="progress">
                                                       <div class="progress-bar bg-amber progress-bar-aqua progress-bar-striped active" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 75%">
                                                  ...
                                                  @if($dat->estatus==='100%')
                                                     <div class="progress">
                                                       <div class="progress-bar bg-green progress-bar-aqua progress-bar-striped active" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 100%">
                                                         <span class="sr-only">100% Complete</span>100%
                                                       </div>
                                                     </div>
                                                  @endif
                                                  @if($dat->estatus==='Entregado')
                                                       <span class="badge bg-green"  >{{$dat->estatus}}</span>
                                                  @endif
                                              ...
                                              <td> {{ $dat->created_at->format('d/M/Y') }}</td>
                                               <td>
                                                   ...
                                                   <a href="{{route ('articulo.show',$dat->id)}}" class="btn btn-xs btn-primary waves-effect" data-toggle="tooltip" data-placement="top" title="" data-original-title="Agregar Articulos">
													                           <i class="material-icons" style="font-size: 16px;">add_circle</i>
                                                   </a>
                                                   @if($dat->total > 0)
                                                     <a href="{{route ('tareas.verpago',$dat->id)}}" class="btn btn-xs btn-primary waves-effect" data-toggle="tooltip" data-placement="top" title="" data-original-title="Pagar Tarea">
                                                   ...
                                                   @else
                                                   <form method='POST' 
                                                         action="{{route('tareas.destroy',$dat['id'])}}"
                                                         style="display:inline"
                                                         class="validar" 
                                                         name="formulario1">
                                                         {{csrf_field()}}
                                                         <input type="hidden" name="_method" value="DELETE"> 
                                                         <button class="btn btn-xs btn-danger waves-effect" data-toggle="tooltip" data-placement="top" title="" data-original-title="Eliminar Tarea">
